...
const MsApp = () => {
    ...
    const doFetch = async () => {
        let result = await fetch('https://gateway-1-charles3.apps.qqd02ebq.usgovvirginia.aroapp.azure.us/api/sample/')
//         let result = await fetch('https://gateway-1-charles3.apps.qqd02ebq.usgovvirginia.aroapp.azure.us/')
    ...
    return (
        <div style={{ padding : '10px', backgroundColor: 'black', color: 'white', minHeight: '100vh', fontSize: '14px' }}>
            <div style={{ fontWeight: 'bold', paddingBottom: '10px', fontSize: '26px' }}>Request Sample React App</div>
